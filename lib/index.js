...
_commander2.default.option('-m, --max', 'The max number of albums to add').option('-s, --status', 'The playlist status (public, private)').parse(process.argv);
...
var createPlaylist = function createPlaylist(_) {
	...
	var status = 'public';
	if (_commander2.default.status === 'private' || _commander2.default.status === 'public') {
		status = _commander2.default.status;
	}
